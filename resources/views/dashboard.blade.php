    ...
    <main class="p-8">
        <div class="bg-white p-8 rounded-lg shadow-lg">
            ...
            <div class="text-center mt-8">
                    <button type="button" data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="bg-emerald-900 text-white py-2 px-4 rounded-[10px] font-bold text-md hover:bg-emerald-300 hover:text-black">
                        Make Appointment
                    </button>
            </div>
